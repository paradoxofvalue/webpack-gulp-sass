...
gulp.task('webpack', function(callback) {
  ...
  let options = {
    entry:   {
      ...
      profilePage: './frontend/js/profilePage',
      cartPage: './frontend/js/cartPage',
...
gulp.task('build', gulp.series('clean', gulp.parallel('styles:assets', 'styles-sass', 'webpack'), 'assets'));
